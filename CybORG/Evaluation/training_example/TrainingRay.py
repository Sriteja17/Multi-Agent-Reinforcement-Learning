...
def env_creator_CC4(env_config: dict):
    ...
    # the above code is just a blueprint , it does not create the agents 
    # nothing is runnig as of now.
    
    cyborg = CybORG(scenario_generator=sg) #simulation starts from this step. (above is initialization)
